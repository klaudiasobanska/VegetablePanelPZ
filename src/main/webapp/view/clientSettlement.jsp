...
<head>
    ...
    <script src="../static/clientSettlement.js"></script>
...
<div id="addOrEditPopup">
    <div id="addOrEditSettCForm"></div>
    <div id="buttonContainer" style="float: right;">
        <div id="saveSettCButton"></div>
        <div id="cancelSettCButton"></div>
    </div>
</div>

<div id="settCGridContainer">
    <div id="settCGrid"></div>
