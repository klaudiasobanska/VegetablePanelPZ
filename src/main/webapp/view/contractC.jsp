...
<head>
    ...
    <script src="./static/contractC.js"></script>
...
<div id="addOrEditPopup">
    <div id="addOrEditContractCForm"></div>
    <div id="buttonContainer" style="float: right;">
        <div id="saveContractCButton"></div>
        <div id="cancelContractCButton"></div>
    </div>
</div>

<div id="contractCGridContainer">
    <div id="contractCGrid"></div>
