...
<head>
    ...
    <script src="./static/contractF.js"></script>
...
<div id="addOrEditPopup">
    <div id="addOrEditContractFForm"></div>
    <div id="buttonContainer" style="float: right;">
        <div id="saveContractFButton"></div>
        <div id="cancelContractFButton"></div>
    </div>
</div>

<div id="contractFGridContainer">
    <div id="contractFGrid"></div>
