...
<head>
    ...
    <script src="../static/farmerSettlement.js"></script>
    <script src="../static/farmerHome.js"></script>
...
<div id="addOrEditPopup">
    <div id="addOrEditSettFForm"></div>
    <div id="buttonContainer" style="float: right;">
        <div id="saveSettFButton"></div>
        <div id="cancelSettFButton"></div>
    </div>
</div>

<div id="settFGridContainer">
    <div id="settFGrid"></div>
