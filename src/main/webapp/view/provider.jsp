...
<head>
    ...
    <script src="./static/provider.js"></script>
...
<div id="addOrEditPopup">
    <div id="addOrEditProviderForm"></div>
    <div id="buttonContainer" style="float: right;">
        <div id="saveProviderButton"></div>
        <div id="cancelProviderButton"></div>
    </div>
</div>

<div id="providerGridContainer">
