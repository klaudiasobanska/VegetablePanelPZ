...
<head>
    ...
    <script src="./static/settlementC.js"></script>
...
<div id="addButton" style="float: left;"></div>
<div id="editButton" style="float: left;"></div>
<div id="deleteButton" style="float: left;"></div>
<div id="addOrEditPopup">
    <div id="addOrEditSettClientForm"></div>
    <div id="buttonContainer" style="float: right;">
        <div id="saveSettClientButton"></div>
        <div id="cancelSettClientButton"></div>
    </div>
</div>

<div id="settClientGridContainer">
    <div id="settClientGrid"></div>
